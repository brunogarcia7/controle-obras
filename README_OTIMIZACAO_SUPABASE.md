...
Publique todos os arquivos do projeto, incluindo o novo `js/storage.js`. O `index.html` e o `app.html` ja apontam para a versao `7.0.0`, o que ajuda a evitar que o navegador mantenha JavaScript antigo.
