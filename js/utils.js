const Utils = {
    ...
    showLoader: (msg = 'Processando...') => { 
        document.getElementById('global-loader-msg').innerText = msg; 
    ...
    showConfirm: (title, message, onConfirm, isDanger = false) => {
        ...
        document.getElementById('confirm-icon').innerText = isDanger ? '🚨' : '⚠️';
        const btnConfirm = document.getElementById('btn-confirm-action'); 
        btnConfirm.style.background = isDanger ? 'var(--danger)' : 'var(--primary)';
        btnConfirm.innerText = isDanger ? 'Sim, Confirmar' : 'Confirmar'; 
        Utils.confirmCallbackAction = onConfirm; 
...
document.getElementById('btn-confirm-action').addEventListener('click', () => { 
    if (Utils.confirmCallbackAction) { 
        const action = Utils.confirmCallbackAction; 
        Utils.confirmCallbackAction = null; 
        Utils.fecharConfirm(); 
        action(); 
    } 
});
